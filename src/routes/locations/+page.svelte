				...
				<table class="w-full divide-y divide-gray-200">
                  ...
                  {location.Verified ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}">
								...
								<td class="px-6 py-4 text-center text-sm font-medium whitespace-nowrap">
									<button
										class="cursor-pointer rounded-full p-1.5 text-gray-600 transition-colors hover:bg-blue-100 hover:text-blue-700"
...
{#if showModal && selectedLocation}
	<LocationModal location={selectedLocation} isOpen={showModal} onClose={closeModal}  />	
{/if}
